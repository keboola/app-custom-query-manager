...
\"column2\" VARCHAR
            ...
            "INSERT INTO {{ id(schemaName) }}.{{ id(tableName) }} (\"column1\", \"column2\") (SELECT COALESCE(\"column1\", '') AS \"column1\",COALESCE(\"column2\", '') AS \"column2\" FROM {{ id(stageSchemaName) }}.{{ id(tableName ~ rand ~ '_tmp') }} AS \"src\")",
